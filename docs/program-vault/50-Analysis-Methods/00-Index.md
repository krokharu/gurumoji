...
`src/gurumoji/analysis_method_registry.py` に登録されている18手法を、実装と査読文献の両方から整理した知識ベース。将来のオーケストレーターは、ここにある入力契約・検証・解釈境界を守って実行計画を作る。
...
- [[04-Conversation/00-Index|会話構造]] — `participation`、`conversation_dynamics`
